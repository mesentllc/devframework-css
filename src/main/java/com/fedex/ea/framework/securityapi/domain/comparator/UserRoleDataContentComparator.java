...
public class UserRoleDataContentComparator
		extends SecurityDataBaseComparator
		implements Serializable, Comparator<UserRoleData> {
	private static final long serialVersionUID = 1L;

	public UserRoleDataContentComparator() {
	}

	public UserRoleDataContentComparator(boolean compareChildren) {
...
/* Location:              F:\MES Folders\Downloads\css-7.0.0.jar!\com\fedex\ea\framework\securityapi\domain\comparator\UserRoleDataContentComparator.class
