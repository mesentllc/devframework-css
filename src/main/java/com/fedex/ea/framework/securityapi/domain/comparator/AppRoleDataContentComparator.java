...
public class AppRoleDataContentComparator
		extends SecurityDataBaseComparator
		implements Serializable, Comparator<AppRoleData> {
	private static final long serialVersionUID = 1L;

	public AppRoleDataContentComparator() {
	}

	public AppRoleDataContentComparator(boolean compareChildren) {
...
/* Location:              F:\MES Folders\Downloads\css-7.0.0.jar!\com\fedex\ea\framework\securityapi\domain\comparator\AppRoleDataContentComparator.class
